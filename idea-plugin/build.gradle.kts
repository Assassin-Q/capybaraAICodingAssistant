...
tasks {
    ...
    patchPluginXml {
        ...
        changeNotes.set(
            ...
            <h3>3.0.1</h3>
            <ul>
              <li><b>流式滚动：</b>发送后自动跟随输出，向上滚轮、拖动滚动条或触摸会立即暂停；执行中回到底部可恢复跟随，任务结束后保留 3 秒展示最终 Token 用量。</li>
              ...
              <li><b>界面修复：</b>打开设置前关闭命令、模型、档位、Git 等临时弹层；连接页新增锚点导航、统一一级标题与内容层级，并将设置侧栏收窄到 160px。</li>
