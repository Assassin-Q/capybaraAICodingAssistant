...
export const zhSystem = {
  ...
  "diff.revert": "回滚本轮修改",
  "diff.revertTitle": "回滚本轮修改？",
  "diff.revertDescription": "这会让 OpenCode 恢复本轮之前的文件状态，并从当前对话中隐藏本轮及后续消息。原消息仍可通过 OpenCode 的恢复操作找回。",
  "diff.revertConfirm": "确认回滚",
  "diff.reverting": "正在回滚…",
  ...
  "opencode.upToDate": "已是最新版本 {version}",
  "opencode.checkInterval": "设置页打开期间每 30 分钟检查一次新版本。",
  ...
  "console.chipLabel": "控制台日志",
  "console.attachmentName": "IDEA-控制台-{index}.log",
  "console.analyzeLogPrompt": "请分析这份 IDEA 控制台日志，概括执行了什么、是否成功、关键阶段、警告与值得关注的信息。",
  "console.analyzeIssuePrompt": "请分析这份 IDEA 控制台日志中的错误或异常，定位最可能的根因，指出关键证据，并给出按优先级排列的修复步骤。",
  "console.analyzeLogInstruction": "将下面的 IDEA 控制台输出作为日志分析上下文。",
  "console.analyzeIssueInstruction": "将下面的 IDEA 控制台输出作为问题排查上下文。",
