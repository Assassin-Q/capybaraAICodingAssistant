...
export const enSystem = {
  ...
  "diff.revert": "Revert this run",
  "diff.revertTitle": "Revert this run?",
  "diff.revertDescription": "OpenCode will restore the files from before this run and hide this run and later messages from the conversation. The server keeps the history for an unrevert.",
  ...
  "opencode.upToDate": "Up to date at {version}",
  "opencode.checkInterval": "Checks for a new version every 30 minutes while Settings is open.",
  ...
  "console.chipLabel": "Console log",
  "console.attachmentName": "IDEA-console-{index}.log",
  "console.analyzeLogPrompt": "Analyse this IDEA console log. Summarise what ran, whether it succeeded, the important phases, warnings and anything worth attention.",
  "console.analyzeIssuePrompt": "Analyse the errors or exceptions in this IDEA console log. Identify the most likely root cause, cite the key evidence and give prioritised repair steps.",
  "console.analyzeLogInstruction": "Use the IDEA console output below as log-analysis context.",
  "console.analyzeIssueInstruction": "Use the IDEA console output below as troubleshooting context.",
