...
export const ConversationScrollButton = ({
  ...
  return (
    !isAtBottom && (
      <Button
        className={cn(
          "absolute bottom-4 left-[50%] translate-x-[-50%] rounded-full border-0 bg-background/90 shadow-none hover:bg-muted focus-visible:ring-0 dark:border-0 dark:bg-background/90 dark:hover:bg-muted",
          className
        )}
