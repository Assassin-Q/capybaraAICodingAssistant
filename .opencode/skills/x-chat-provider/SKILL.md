...
| 场景类型 | 难度 | 示例链接 | 说明 |
| --- | --- | --- | --- |
| **标准OpenAI** | 🟢 简单 | [内置Provider示例](references/EXAMPLES.md#场景1：OpenAI 格式) | 直接使用内置Provider |
| **标准DeepSeek** | 🟢 简单 | [内置Provider示例](references/EXAMPLES.md#场景2 DeepSeek 格式) | 直接使用内置Provider |
| **私有API** | 🟡 中等 | [自定义Provider的一些细节场景](references/EXAMPLES.md#场景3：自定义 provider) | 需要四步实现 |

> 📖 **完整示例**：[EXAMPLES.md](references/EXAMPLES.md) 包含所有实际场景的完整代码
...
- [EXAMPLES.md](references/EXAMPLES.md) - 实战示例代码
